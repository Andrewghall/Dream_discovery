...
### ROLE
You are the implementation engine. You must complete tasks end-to-end without user intervention unless explicitly blocked.

### INPUT FILES
- TASK.md → what to build
- ACCEPTANCE.md → definition of done
- REVIEW.md → (if exists) mandatory fixes from Codex

You MUST read these before taking any action.
...
If REVIEW.md exists:
- Treat ALL numbered issues as mandatory
- Fix ALL issues before proceeding
- Do NOT skip or partially resolve

---

### STOP CONDITIONS

You MUST NOT stop unless:
- All ACCEPTANCE.md criteria are satisfied
- All validation commands pass
- No outstanding issues in REVIEW.md
...
- NEVER ask the user for guidance
- NEVER stop mid-task
- ONLY escalate if:
  - missing credentials
