                  ...
                  <Link href={uc.href} className="block group">
                    <div className="bg-[#0d0d0d] rounded-3xl p-8 sm:p-10 overflow-hidden relative">
                      ...
                      <div className="relative z-10">
                        ...
                        <p className="text-white/80 max-w-2xl leading-relaxed mb-4">{uc.description}</p>
                        <div className="flex flex-wrap gap-2 mb-6">
                          {uc.tags.map((tag) => (
                            <span key={tag} className="px-2.5 py-1 text-xs text-white/75 border border-white/10 rounded-full">
                              {tag}
                            </span>
                          ))}
                        </div>
