        ...
        >
          ...
          />
              ...
              <LiveSnapshotsCard
                ...
                onRefresh={() => void fetchSnapshots()}
                onLoad={() => void loadSnapshot()}
                snapshotsError={snapshotsError}
              />

              <LiveRevealCard
                revealReadiness={revealReadiness}
                dialoguePhase={dialoguePhase}
                liveReportDownloading={liveReportDownloading}
                utteranceCount={utteranceNodes.length}
                visionNarrative={visionNarrative}
                domainNarratives={domainNarratives}
                pressurePoints={pressurePoints}
                keyDependencies={keyDependencies}
                revealOpen={revealOpen}
                onRevealOpenChange={setRevealOpen}
                onDownloadLiveReport={downloadLiveReport}
              />

              <LiveLensCard
                lensNames={blueprintLensNames}
                lensDomain={lensDomain}
                onLensDomainChange={(v) => setLensDomain(v as LiveDomain | null)}
              ...
              <LiveActorJourneyMap
                ...
                expanded={actorJourneyExpanded}
                onToggleExpanded={() => setActorJourneyExpanded((v) => !v)}
                onInteractionClick={setSelectedNodeId}
              />
