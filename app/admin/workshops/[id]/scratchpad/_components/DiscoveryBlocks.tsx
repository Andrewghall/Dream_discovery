...
const LENS_COLOURS: Record<string, { bg: string; border: string; dot: string }> = {
  ...
  Operations:   { bg: 'bg-emerald-50', border: 'border-emerald-200',dot: 'bg-emerald-500' },
  Technology:   { bg: 'bg-orange-50',  border: 'border-orange-200', dot: 'bg-orange-500'  },
  Commercial:   { bg: 'bg-purple-50',  border: 'border-purple-200', dot: 'bg-purple-500'  },
  'Risk/Compliance': { bg: 'bg-red-50', border: 'border-red-200', dot: 'bg-red-500' },
  Finance:      { bg: 'bg-violet-50',  border: 'border-violet-200', dot: 'bg-violet-500' },
  Partners:     { bg: 'bg-indigo-50',  border: 'border-indigo-200', dot: 'bg-indigo-500' },
};
