    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          {NAV_LINKS.map((link) =>
            link.href ? (
              <Link
                key={link.href}
                href={link.href}
                className={`px-2.5 py-2 text-[13px] font-medium rounded-lg transition-colors ${
                  isActive(link.href)
        ...
        <div className="hidden lg:flex items-center gap-2">
          <a
            href="/experience"
            className="flex items-center gap-1.5 px-2.5 py-2 text-[13px] font-semibold rounded-lg text-[#5cf28e] border border-[#5cf28e]/25 bg-[#5cf28e]/5 hover:bg-[#5cf28e]/15 transition-all"
          >
          ...
          {/* WhatsApp — icon only on desktop to save space */}
          <a
            href="https://wa.me/447471944765"
            target="_blank"
            rel="noopener noreferrer"
            className="p-2 rounded-lg text-slate-400 hover:text-[#25D366] hover:bg-slate-50 transition-all"
          ...
          <CalendlyButton
            className="px-3.5 py-2 text-[13px] font-semibold rounded-lg bg-[#5cf28e] text-[#0d0d0d] hover:bg-[#50c878] transition-all shadow-sm cursor-pointer"
          >
            Book a Demo
          </CalendlyButton>
          <Link
            href="/login"
            className="px-3.5 py-2 text-[13px] font-semibold rounded-lg transition-all border border-slate-200 text-slate-700 hover:bg-slate-50"
          >
            Sign In
          </Link>
        </div>
