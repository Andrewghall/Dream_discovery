...
import { Bot, User, Users, ArrowRight } from 'lucide-react';
    ...
    <div className="space-y-10">
      ...
      {hasNewFormat && (
        <>
          ...
          {/* 3. Primary themes — two-panel explorer */}
          ...
          {/* 4. Supporting themes — two-panel explorer */}
          ...
          {/* 7. Overall direction of travel — bottom */}
