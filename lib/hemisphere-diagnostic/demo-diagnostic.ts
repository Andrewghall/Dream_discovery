...
export const DEMO_DIAGNOSTIC_BEFORE: HemisphereDiagnostic = {
  ...
  biasDetection: {
    contributionBalance: [
      { actor: 'Sarah Chen', share: 0.14, mentionCount: 44 },
      { actor: 'James Wright', share: 0.12, mentionCount: 37 },
      { actor: 'Maria Lopez', share: 0.11, mentionCount: 34 },
      { actor: 'Andrew Thornton', share: 0.08, mentionCount: 25 },
      { actor: 'Natasha Ivanova', share: 0.09, mentionCount: 28 },
      { actor: 'David Kim', share: 0.07, mentionCount: 22 },
      { actor: 'Emma Taylor', share: 0.06, mentionCount: 19 },
      { actor: 'Tom Richards', share: 0.05, mentionCount: 16 },
      { actor: 'Lisa Patel', share: 0.04, mentionCount: 12 },
      { actor: 'Ryan O\'Brien', share: 0.06, mentionCount: 19 },
      { actor: 'Amy Zhang', share: 0.05, mentionCount: 16 },
      { actor: 'Others', share: 0.13, mentionCount: 40 },
    ],
...
export const DEMO_DIAGNOSTIC_AFTER: HemisphereDiagnostic = {
  ...
  biasDetection: {
    contributionBalance: [
      { actor: 'Sarah Chen', share: 0.11, mentionCount: 112 },
      { actor: 'James Wright', share: 0.10, mentionCount: 102 },
      { actor: 'Maria Lopez', share: 0.09, mentionCount: 92 },
      { actor: 'Andrew Thornton', share: 0.07, mentionCount: 71 },
      { actor: 'Natasha Ivanova', share: 0.08, mentionCount: 82 },
      { actor: 'David Kim', share: 0.08, mentionCount: 82 },
      { actor: 'Emma Taylor', share: 0.07, mentionCount: 71 },
      { actor: 'Tom Richards', share: 0.06, mentionCount: 61 },
      { actor: 'Lisa Patel', share: 0.06, mentionCount: 61 },
      { actor: 'Ryan O\'Brien', share: 0.07, mentionCount: 71 },
      { actor: 'Amy Zhang', share: 0.06, mentionCount: 61 },
      { actor: 'Others', share: 0.15, mentionCount: 153 },
    ],
