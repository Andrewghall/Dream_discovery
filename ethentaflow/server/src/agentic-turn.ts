...
async function askModelForDecision(params: {
  ...
  const systemPrompt = [
    ...
    'WEAK: "What specifically is holding you at a three?" — generic, does not reference what they said',
    ...
    '',
    'Choose move="advance" only when all guide question topics have been meaningfully covered OR sufficiency >= 80 OR time is critically short.',
